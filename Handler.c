...
//         // 2. create cpu begin
//         Event job_begin;
//         job_begin.jobSeq = task->jobSeq;
//         job_begin.time = task->time;
//         job_begin.type = 2; // begin cpu
